      ...
      <main>
        <div className="container flex min-h-screen flex-col">
          <div className="flex items-start justify-between">
            <div className="flex items-center justify-start gap-x-2 pt-9">
              <Logo />
            ...
            <LinkAnchor
              size="xl"
              className="pr-0 pt-6 hover:bg-opacity-0"
              theme="primary-alt"
              href="/"
            >
              <Icon
                icon={CLOSE_SVG as string}
                className="inline-block h-10 w-10 rounded-full text-white transition-all duration-500 hover:bg-500 hover:bg-opacity-20 sm:h-14 sm:w-14"
              />
            </LinkAnchor>
          </div>
          <Quiz />
